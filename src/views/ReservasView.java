...
//Esta clase fue creada para encapsular la adición de un registro en la tabla Reservas mientras sigue siendo amigable al usuario
...
public class ReservasView extends JFrame {
	...
	public ReservasView(Reserva reservaciones) {
		super("Reserva");
			...
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaEntrada.getDate()!=null&&txtFechaSalida.getDate()!=null) {
					...
					if(d2.compareTo(d1)>0) {
						...
						valor=diferencia*reservaciones.recuperaValor(txtValor.getSelectedItem().toString());
						labelValor.setText("Total a pagar: $ "+valor+" m.n");
						System.out.println("Total a pagar: $ "+valor+" m.n"+" Valor Diario:"+reservaciones.recuperaValor(txtValor.getSelectedItem().toString()));
					}else
						if(d2.compareTo(d1)<=0) {
		...
		txtValor.addItemListener(new ItemListener() {
		    public void itemStateChanged(ItemEvent arg0) {
				//Activa el evento, después del usuario cambiar valor se debe calcular el valor de la reserva
				if(txtFechaEntrada.getDate()!=null&&txtFechaSalida.getDate()!=null) {
					java.util.Date d1= (java.util.Date) txtFechaEntrada.getDate();
					java.util.Date d2= (java.util.Date) txtFechaSalida.getDate();
					System.out.println("Entro a la comparacion de fechas");
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					...
					int idRegistro=reservaciones.agregar(txtFechaEntrada.getDate(), 
							txtFechaSalida.getDate(), valor, txtFormaPago.getSelectedIndex());
					RegistroHuesped registro = new RegistroHuesped(reservaciones, idRegistro);
		...
		labelValor = new JLabel("Total a pagar: $ "+valor+" m.n");
		labelValor.setForeground(SystemColor.textInactiveText);
		labelValor.setBounds(38, 493, 180, 35);
		labelValor.setFont(new Font("Roboto Black", Font.PLAIN, 14));
	...
	//Este método cierra la ventana una vez que finaliza la operación
	private void cerrar() {
		this.dispose();
	}
