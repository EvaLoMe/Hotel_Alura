...
// La clase EditarHuesped se creó para actualizar o corregir el registro de un huesped
...
public class EditarHuesped extends JFrame {
	...
	public EditarHuesped(Reserva reservaciones, String Nombre, String Apellido,String Telefono,String FechaN,String Nacionalidad,String NReserva,String Id) {
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				ReservasView reservas = new ReservasView( reservaciones);
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				actualizaHuesped(txtNombre.getText(), txtApellido.getText(), txtTelefono.getText(), Integer.parseInt(txtNreserva.getText()), txtFechaN.getDate(), (String)txtNacionalidad.getSelectedItem(), Integer.parseInt(Id));
		...
		btnguardar.setFont(new Font("Roboto", Font.PLAIN, 18));
		...
		try {
			fechaParseada = new SimpleDateFormat("yyyy-MM-dd").parse(FechaN);
		} catch (ParseException e1) {
			
			e1.printStackTrace();
		}
		this.txtFechaN.setDate(fechaParseada);
		
		this.txtNreserva.setText(NReserva+"");
		
		this.txtNreserva.setEditable(false);
		
		this.setVisible(true);
	}
	// Este método finaliza el proceso del botón guardar
	private void actualizaHuesped(String Nombre, String Apellido, String Telefono, 
			int Nreserva, java.util.Date fecha, String Nacionalidad, int idReserva) {
		reservaciones.actualizaHuesped(Nombre, Apellido, Telefono, Nreserva, fecha, Nacionalidad, idReserva);;
		Exito dialog =new Exito(reservaciones, "Datos guardados satisfactoriamente");
		dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		dialog.setVisible(true);
		cerrar();
