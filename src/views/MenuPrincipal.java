...
import sistema.*;
// Esta clase es la raiz del GUI, en ella se inicializan los dos elementos claves que son la autenticación y las reservas
...
public class MenuPrincipal extends JFrame {
	...
	//Este método se creó como método principal del GUI, aquí se instancía el funcionamiento total del programa
	...
	//Este método crea el menu de origen
	public MenuPrincipal() {
		...
		pwdManager= new Autenticacion();
		
		
		reservaciones= new Reserva(new Hotel(), new ReservaDAO(), new HuespedesDAO());
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Login login = new Login(pwdManager, reservaciones);
