...
//Se creó la clase RegistroHuesped para agregar un nuevo huesped a la tabla, comienza con todos los campos vacíos
...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	//Este método crea la ventana de registro
	public RegistroHuesped(Reserva reservaciones, int idRegistro) {
		...
		//Cargar noReserva
		this.txtNreserva.setText(idRegistro+"");
		this.txtNreserva.setEditable(false);
	}
	// Este método notifica a Reserva para agregar un huesped
	private void registraHuesped() {
	...
	//Este método cierra la ventana al finalizar la operación
	private void cerrar() {
		this.dispose();
	}
