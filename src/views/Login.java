...
import sistema.*;
// Esta clase se crea para autenticar al usuario
public class Login extends JFrame {

	/**
	 * 
	 */
	// Se encapsula el método  de autenticación
	...
	private Autenticacion pwdManager;
	/**
	...
	public Login(Autenticacion autenticacion, Reserva reservaciones) {
		pwdManager=autenticacion;
		setResizable(false);
		setUndecorated(true);
	...
	// Método para comparar los parámetros recibidos con los que deben ser correctos
	private void Login(Reserva reservaciones) {

	        if(pwdManager.autentificar(txtUsuario.getText(),  String.valueOf(txtContrasena.getPassword()))){
	            MenuUsuario menu = new MenuUsuario( reservaciones);
	            menu.setVisible(true);
	            dispose();	 
	        }else {
	            JOptionPane.showMessageDialog(this, "Usuario o Contraseña no válidos");
	            System.out.println(txtUsuario.getText()+" "+String.valueOf(txtContrasena.getPassword()));
	        }
	} 
	// eventos del mouse
