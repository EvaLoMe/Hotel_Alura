...
//La clase se creó para ordenar el programa, contiene el main necesario para la ejecución
	 ...
	 */
	// Se creó este método para hacer pruebas
	 ...
	 * Create the frame.
	 */
	//Este método se creó para crear la ventana de registro
	public MenuUsuario(Reserva reservaciones) {
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				Busqueda busqueda = new Busqueda(reservaciones);
	...
	// Estos métodos son eventos del mouse
